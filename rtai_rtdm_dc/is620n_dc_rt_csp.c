 ...
 *  gcc -o is620n_dc_rt_csp is620n_dc_rt_csp.c -I/opt/etherlab/include -L. -L/opt/etherlab/lib -Wl,--rpath=./ -Wl,--rpath=/opt/etherlab/lib -lethercat -lm -lrt -lipipe_64
 *****************************************************************************/
