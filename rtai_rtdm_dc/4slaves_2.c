 ...
 *  这个例子在rtai下,使用
 *  从站连接顺序是:
 *  -->EK1100-->EL1008-->EL2008->IS620N
 *build:
   $gcc -o 4slaves 4slaves.c -I/opt/etherlab/include -I/opt/rtai-5.1/include -L/opt/rtai-5.1/lib -L/opt/etherlab/lib -llxrt -lrtdm -lethercat -lpthread -Wl,--rpath=/opt/rtai-5.1/lib -Wl,--rpath=/opt/etherlab/lib
 *run:
...
const static ec_pdo_entry_reg_t domain1_regs[] = {
    //RxPDO
    {IS620NSlavePos, INOVANCE_IS620N, 0x6040, 0, &offset[0].control_word_6040_0}, //IS620N
    ...
    //TxPDO
    {IS620NSlavePos, INOVANCE_IS620N, 0x603F, 0, &offset[0].error_code_603f_0},
...
//配置IS620结束
    ...
    ret = ecrt_master_select_reference_clock(master, sc_is620n/*sc_ek1100*/);
    if (ret < 0) {
