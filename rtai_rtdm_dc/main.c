 ...
 *
 *build:
   $gcc -o main main.c -I/opt/etherlab/include -I/opt/rtai-5.1/include -L/opt/rtai-5.1/lib -L/opt/etherlab/lib -llxrt -lrtdm -lethercat -lpthread -Wl,--rpath=/opt/rtai-5.1/lib -Wl,--rpath=/opt/etherlab/lib
 *run:
