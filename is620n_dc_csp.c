...
const static ec_pdo_entry_reg_t domain1_regs[] = {
    ...
    {IS620NSlavePos, INOVANCE_IS620N, 0x6072, 0, &offset.max_torque_6072_0},
    //TxPDO
...
static ec_pdo_info_t IS620N_pdos[] = {
    //RxPdo
    {0x1600, 4, IS620N_pdo_entries + 0 },
    //TxPdo
    {0x1A00, 9, IS620N_pdo_entries + 4 }
};
...
void cyclic_task()
{
	...
	printf("\r%6f    \t    ",((float)temp[1]/1000) );
        ...
        /*if(servooff==1){//servo off
            ...
            EC_WRITE_S32(domain1_pd+offset.target_position_607a_0,0);
	    EC_WRITE_S32(domain1_pd+offset.max_torque_6072_0, 0xf00);
